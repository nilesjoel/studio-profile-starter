    ...
    <Field name={fieldName} validate={validation}>
      {({ input, meta }) => (
        <>
          ...
          <StyledInput {...input} type={fieldType} placeholder={placeholder} />
...
const SymmetryForm = (props) => {
  const { symmetryFields, layout, variation } = props;
  return (
